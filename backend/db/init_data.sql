...
('menu-menus', '菜单管理', '/menus', 'MenuOutlined', NULL, 7, TRUE, 'menu'),
...
-- 用户管理操作按钮
('menu-users', '用户管理菜单', '/users', 'UserOutlined', NULL, 8, TRUE, 'menu'),
('menu-user-add', '新增用户', '', '', 'menu-users', 1, TRUE, 'button'),
('menu-user-edit', '编辑用户', '', '', 'menu-users', 2, TRUE, 'button'),
('menu-user-delete', '删除用户', '', '', 'menu-users', 3, TRUE, 'button'),

-- 职位管理操作按钮
('menu-positions', '职位管理菜单', '/positions', 'SolutionOutlined', NULL, 9, TRUE, 'menu'),
('menu-pos-add', '新增职位', '', '', 'menu-positions', 1, TRUE, 'button'),
('menu-pos-edit', '编辑职位', '', '', 'menu-positions', 2, TRUE, 'button'),
('menu-pos-delete', '删除职位', '', '', 'menu-positions', 3, TRUE, 'button'),

-- 菜单管理操作按钮
('menu-menu-add', '新增菜单', '', '', 'menu-menus', 1, TRUE, 'button'),
('menu-menu-edit', '编辑菜单', '', '', 'menu-menus', 2, TRUE, 'button'),
('menu-menu-delete', '删除菜单', '', '', 'menu-menus', 3, TRUE, 'button'),

-- 审计日志菜单
('menu-audit', '审计日志', '/audit-logs', 'AuditOutlined', NULL, 10, TRUE, 'menu');
...
('user-001', 'Dr. Elena Rodriguez', 'elena.rodriguez@seuu.edu', NULL, 'ER', 'dept-review', 'full', TRUE, 'staff', 'elena', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36CHQa9C'),
('user-002', '陈伟', 'chen.wei@seuu.edu', NULL, 'CW', 'dept-outreach', 'full', TRUE, 'staff', 'chenwei', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36CHQa9C'),
('user-003', 'Sarah Jenkins', 'sarah.jenkins@seuu.edu', NULL, 'SJ', 'dept-ethics', 'partial', TRUE, 'staff', 'sarah', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36CHQa9C'),
('user-004', 'Marcus Low', 'marcus.low@seuu.edu', NULL, 'ML', 'dept-editorial', 'inactive', TRUE, 'staff', 'marcus', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36CHQa9C'),
...
('user-006', '刘建国', 'liu@seuu.edu', NULL, 'LJG', 'dept-ie', 'full', TRUE, 'staff', 'dean001', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36CHQa9C'),
('user-007', '李德', 'li.de@seuu.edu', NULL, 'LD', 'dept-cs', 'full', TRUE, 'staff', 'lecturer001', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36CHQa9C'),
('user-008', '周鹏', 'zhou.peng@seuu.edu', NULL, 'ZP', 'dept-cs-ai-lab', 'full', TRUE, 'staff', 'zhoupeng', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36CHQa9C'),
('user-009', '何坤', 'he.kun@seuu.edu', NULL, 'HK', 'dept-cs-sys', 'full', TRUE, 'staff', 'hekun', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36CHQa9C'),
('user-010', '王芳', 'wang.fang@seuu.edu', NULL, 'WF', 'dept-se', 'full', TRUE, 'staff', 'wangfang', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36CHQa9C');
...
INSERT IGNORE INTO position_categories (code, name, color, icon, sort_order, description) VALUES
...
INSERT IGNORE INTO positions (id, name, code, category_code, level, description, headcount) VALUES
...
INSERT IGNORE INTO user_positions (user_id, position_id) VALUES
('user-005', 'pos-006'),
('user-006', 'pos-006'),
('user-007', 'pos-002'),
('user-008', 'pos-003'),
