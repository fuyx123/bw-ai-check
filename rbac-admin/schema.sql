...
CREATE TABLE IF NOT EXISTS departments (
  ...
  level ENUM('university', 'college', 'major') NOT NULL,
  leader_name VARCHAR(50),
  leader_title VARCHAR(50),
  staff_count INT DEFAULT 0,
  status ENUM('operational') DEFAULT 'operational',
...
CREATE TABLE IF NOT EXISTS roles (
  ...
  data_scope ENUM('school', 'college', 'major', 'class') DEFAULT 'school',
...
CREATE TABLE IF NOT EXISTS users (
  ...
  access_status ENUM('full', 'partial', 'inactive') DEFAULT 'full',
